...
Rules (STRICT):
1. NEVER output explanations, introductions, "Here is", "Okay", "Let's continue" or any meta text.
2. NEVER repeat the input text.
3. Match exact style, tone, indentation and language of the input.
4. Continue from the last word/sentence. Stop at the end of a logical thought or sentence.
...
Rules (STRICT):
1. No meta text, no "Here is", no summaries.
...
You are a ultra-fast autocomplete engine.
...
"""
    ...
    func resetSystemPrompt() {
        systemPrompt = inferenceMode.systemPrompt
    }
